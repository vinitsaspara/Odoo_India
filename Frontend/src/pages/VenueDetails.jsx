...
import { getSportPlaceholder, handleImageError } from '../utils/placeholderImages';
...
const VenueDetails = () => {
  ...
  const fetchVenueDetails = async () => {
    ...
    try {
      // Skip API call and use mock data directly due to backend unavailability
      console.log('Using mock data for venue details');
  ...
  const generateMockVenueDetails = (venueId) => {
    ...
    return {
      ...
      amenities: [
        'Parking', 'WiFi', 'Cafeteria', 'Security', 'Lighting', 
        'Changing Room', 'First Aid', 'Equipment Rental'
      ],
      ...
      courts: [
        {
          ...
          features: ['Professional Flooring', 'LED Lighting', 'Air Conditioning'],
          isActive: true
        },
        {
          _id: 'court-2',
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">About this venue</h2>
                  <div className="flex items-center space-x-4 text-sm text-gray-600">
                    <div className="flex items-center">
                      <Star className="h-4 w-4 text-yellow-400 fill-current mr-1" />
                      <span className="font-medium">{venue.rating}</span>
                      <span className="ml-1">({venue.totalReviews} reviews)</span>
                    </div>
                    <div className="flex items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">{venue.operatingHours.weekdays}</span>
                </div>
              </div>

              {/* Sports Types */}
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gray-900 mb-3">Available Sports</h3>
            ...
            {/* Courts List */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Available Courts</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">₹{venue.priceRange.min} - ₹{venue.priceRange.max}/hr</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{venue.operatingHours.weekdays}</span>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">₹{selectedCourt.pricePerHour}</span>
                </div>
              </div>
            </div>
